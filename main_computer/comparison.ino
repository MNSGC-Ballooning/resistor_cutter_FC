...
//  uint8_t gpsAltSTATE = INITIALIZATION;
  ...
  float latA = dataPacketA.latitude, latB = dataPacketB.latitude, latC = latitude[0], latAPrev = 0, latBPrev = 0, latCPrev = 0;
  float lonA = dataPacketA.longitude, lonB = dataPacketB.longitude, lonC = longitude[0], lonAPrev = 0, lonBPrev = 0, lonCPrev = 0;
  float altA = dataPacketA.Altitude, altB = dataPacketB.Altitude, altC = alt[0], altAPrev = 0, altBPrev = 0, altCPrev = 0;
